...
const SpaceItem = (props: Props) => {
  const oaLogin = () => {
    window.location.href = `${process.env.REACT_APP_ONEAUTH_URL}/#/space/${props.space.spaceId}/login?type=signin&appId=${process.env.REACT_APP_ONEAUTH_APP_ID}&asset=${props.asset}`;
  };
  return (
